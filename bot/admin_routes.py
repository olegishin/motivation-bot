...
# 13 - bot/admin_routes.py - 26.01.2026
# 13 - bot/admin_routes.py - 27-29.01.2026
...
# ✅ ДОБАВЛЕНО (2026-01-27): Полная система уровней для WebApp профиля
# ✅ ИСПРАВЛЕНО (2026-01-29): КРИТИЧЕСКАЯ БЕЗОПАСНОСТЬ - Защита WebApp профиля через initData
# ✅ ДОБАВЛЕНО: Проверка HMAC подписи Telegram для предотвращения несанкционированного доступа
# ✅ СОХРАНЕНО: Вся логика админки, JWT, TOTP, уровни, батарейка
